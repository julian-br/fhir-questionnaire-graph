...
export default function AnswerOptionNode({ data }: NodeProps<AnswerNodeData>) {
  return (
    <NodeContainer>
      <div className="w-52 rounded-xl border-2 border-slate-300 bg-primary-100 py-2 px-4 text-sm font-medium text-primary-900 hover:border-2 hover:border-primary-400">
